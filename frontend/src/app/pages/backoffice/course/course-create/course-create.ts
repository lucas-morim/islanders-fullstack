...
export class CourseCreate implements OnInit {
  ...
  onCoverChange(ev: Event) {
    ...
    // Quando tiver upload real, a gente adapta esse fluxo.
  }
  ...
  async submit() {
    ...
    try {
      ...
      const payload: CourseCreatePayload = {
        ...
        photo: v.photo ? v.photo : null, // futuramente pode ser URL da imagem enviada
